...
export default function HeartDiseaseForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    const apiUrl =
      "https://heart-disease-prediction-4-lzr7.onrender.com/predict";
    ...
    >
      ...
      <div className="space-y-4">
          ...
          <Label htmlFor="HadStroke" className="flex items-center">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>
                    A stroke occurs when blood supply to part of your brain is
        ...
        <div>
          ...
          <Select
            onValueChange={(value) =>
              handleChange("AgeCategory", ageGroups.indexOf(value) + 1)
            }
          >
            <SelectTrigger className="w-full">
        ...
        <div>
          <Label htmlFor="ChestScan">
            Have you ever undergone a chest scan?
          </Label>
        ...
        <div>
          <Label htmlFor="DifficultyWalking">
            Do you experience difficulty walking?
          </Label>
          <Select
        ...
        <div>
          <Label htmlFor="HadDiabetes">
            Have you ever been diagnosed with kidney disease by a healthcare
            provider?
          </Label>
        ...
        <div>
          <Label htmlFor="HadDiabetes">
            Have you ever been diagnosed with arthritis (e.g., osteoarthritis,
